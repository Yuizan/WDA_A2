...
<div class="manageFormItemPanel">
    <ul>
        ...
        @if($ticket->Status === "Pending" || $ticket->Status === "In Progress"||$ticket->Status === "Unresolved")
        <li class="formItem">
            ...
            <div id="formDetail{{$ticket->Tid}}" class="formDetail" style="display: none">
                ...
                <div id="formComment{{$ticket->Tid}}" class="formComment">
                    <p>Replay</p>
                    <textarea class="formCommentTA" name="Replay"disabled="disabled">{{$ticket->comment->Replay}}</textarea>
                </div>
            </div>
            <div id="formEditSubmit{{$ticket->Tid}}" class="formEditSubmit" style="display: none">
                <span class="formStatusSpan">{{$ticket->Status}}</span>
            </div>
            {!! Form::close() !!}
        </li>
        @endif
